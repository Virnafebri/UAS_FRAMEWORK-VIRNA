    ...
    <div class="row no-gutters mt-5">
      ...
      <li class="nav-item">
        ...
        <div class="col-md10 p-5 pt-2">
          ...
          <a href="tambah_mhs.php" class="btn btn-primary mb-2"><i class="fas fa-plus mr-2"></i> TAMBAH DAFTAR MAHASISWA</a>
      ...
      ?>
        <tr>
          ...
          <td>
            ...
            <a onClick="return confirm('Data yang sudah dihapus tidak dapat dikembalikan!?')" href="hapus_mhs.php?NIM=<?php echo $data['NIM'] ?>"><button type="button" class="btn btn-warning">Hapus</button></a>
          </td>
        </tr>
      <?php } ?>
            </tbody>
