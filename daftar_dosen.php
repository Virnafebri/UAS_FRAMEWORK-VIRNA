    ...
    <div class="row no-gutters mt-5">
      ...
      <li class="nav-item">
        ...
        <div class="col-md10 p-5 pt-2">
          ...
          <a href="tambah_dosen.php" class="btn btn-primary mb-2"><i class="fas fa-plus mr-2"></i> TAMBAH DAFTAR DOSEN</a>
      ...
      ?>
        <tr>
          ...
          <td>
            ...
            <a onClick="return confirm('Data yang sudah dihapus tidak dapat dikembalikan!?')" href="hapus_dosen.php?kd_dos=<?php echo $data['kd_dos'] ?>"><button type="button" class="btn btn-warning">Hapus</button></a>
          </td>
        </tr>  
      <?php } ?>
