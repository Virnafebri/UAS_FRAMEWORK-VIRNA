...
if (isset($_POST['simpan'])) {
  ...
  $nilai   = $_POST['nilai'];
	...
	$queryMysql = "INSERT INTO nilaimhs (kd_mk,NIM,nama_mk,nilai) VALUES ('$kdMk','$nim','$namaMk','$nilai')";
...
<div class="mb-2 row">
    ...
    <div class="col-sm-4">
      <input type="text" name="nilai" placeholder="Masukkan Nilai" size="80" class="form-control" />
    </div>
  </div>
